...
-- Schema urbanhuntdb
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `urbanhuntdb` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`administrator` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`agent` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`agency` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`guest` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`real_estate` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`guest_real_estate_rating` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`image` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `urbanhuntdb`.`tour` ;
